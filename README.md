...
│       ├── cron/gitpage-heartbeat/   Daily gitpage status refresh
...
│   ├── gitpage/           Client SDK + subscription status check
...
instrumentation.ts         Cold-start gitpage status ping + QStash schedule registration
...
| `system/heartbeat`, `system/gitpageStatus` | Cached gitpage subscription status |

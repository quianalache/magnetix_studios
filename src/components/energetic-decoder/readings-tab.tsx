...
import { Copy, Loader2, Search, ExternalLink, FileOutput, Eye, Download, SlidersHorizontal, Trash2 } from "lucide-react";
...
import { NewReadingDialog } from "@/components/energetic-decoder/new-reading-dialog";
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between gap-3">
        ...
        <div className="flex shrink-0 items-center gap-2">
          ...
          <NewReadingDialog onCreated={handleReadingCreated} />
        </div>
      </div>

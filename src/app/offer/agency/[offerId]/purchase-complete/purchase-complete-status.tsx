 ...
 *  poller — no One-Click Upsell interstitial or Space bridge (neither
 *  exists at agency scope; see agency-course-offer-purchase-service.ts).
 *  Lands the buyer on the first bundled course's classroom, or MyMagnetix
 *  home if the offer somehow bundled zero courses. */

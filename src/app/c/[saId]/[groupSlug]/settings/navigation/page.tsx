...
/**
 * Community Settings → Navigation. Same admin-only re-verification as
 * General and Branding — a moderator-role check independent of whatever
 * the Settings nav happens to show/hide client-side.
 */
export default async function CommunityNavigationSettingsPage({
  params,
}: {

...
export const AI_SUITE_KNOWLEDGE: AiSuiteKnowledgeCard[] = [
  ...
  },
  {
    ...
    keywords: ["contact", "lead", "people", "import", "csv", "export", "notes", "activity", "tags", "custom field", "filter", "contact list", "segment", "columns", "first name", "last name", "purchases", "grant access"],
    body:
      "Contacts holds every lead and customer for the sub-account. The list shows 25 contacts per page with search, quick filters (source, tags, company, created date), More filters (any contact field, dates, custom fields, and purchases & access such as 'purchased offer X'), and Customize columns (saved per user). Filters can be saved as Contact Lists — dynamic segments that update automatically as contacts change, and that can also be picked as a Broadcast audience. Contacts have first name, last name, full name, state/region and postal code fields. Open a contact to see its profile: contact details and tags on the left; Conversations, Activity and Notes tabs in the middle (notes show their author and can be edited by their author or deleted by the author or an admin); and on the right Deals, Tasks, Projects, Submitted Forms, Purchases & Access, and Quotes. Admins can grant complimentary community access, or enrollment in open courses and free offers, from Purchases & Access, and revoke complimentary community access there; paid courses and offers still require a purchase. You can import and export contacts as CSV. Contacts carry a source badge (e.g. Web Chat, Booking, Form) and captured marketing attribution when they arrived via a public form. Contacts (and deals) also support custom fields defined under Settings → Custom Fields. The assistant can add a contact (with tags) or search contacts for you.",
  },
  {
    id: "custom-fields",
    levels: ["sub-account"],
